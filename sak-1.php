...
<br><br>
<center><h2  style="color: red;">पाणिनीयव्याकरणोदाहरणकोशः - सूत्राणि-1 - अक्षरक्रमेण </h2></center>	
</div>
<script>
$(document).on('change', '[name="lang"]' , function(){
	...
	else if(val1 === "e")
	{
		...
		document.getElementById("i1").innerHTML="Select the first letter of the sūtra. Select the sūtra in the scrolling list in the first window along with its reference in the Aṣṭādhyāyī and in the Siddhāntakaumudī. Its examples will appear in the second window.  Select the example and click on OK.";
		document.getElementById("cs").innerHTML="&nbsp; &nbsp; &nbsp; Sūtra-s";
...
<center>
<p><center>
<label id="i1">सिद्धान्तकौमुद्यां तद्धितनिष्पादनार्थं संगृहीतानि सूत्राणि  सर्वाणि प्रदर्शितानि। अपेक्षितस्य सूत्रस्य प्रथमाक्षरं चिनोतु। ततः अक्षरमालायां यदक्षरं चितं तदक्षरादीनि कानिचन सूत्राणि  अष्टाध्यायीसूत्रसंख्यया, सिद्धान्तकौमुदीक्रमसंख्यया च प्रथमपेटिकायाम् आविर्भवन्ति। ततः अपेक्षितं सूत्रं  चिनोतु। ततः तत्सूत्रसंबद्धानि उदाहरणानि द्वितीयपेटिकायाम् आविर्भवन्ति। ततः अपेक्षितम् उदाहरणं द्रष्टुम् अस्तु इत्यत्र नोदनं करोतु।
</label></center></p>
<br>
<br>
...
function loadexamples(){
	...
	readTextFile("http://localhost/tadditha/tadditha.JSON", function(text){
		...
		for(i=0;i<=data1.d.length-1;i++)
		{
			...
			{
				if(data1.d[i].Sutra[j].indexOf(sas[1]) !== -1)
				{
...
$(document).ready(function() {
    ...
    //alert("in1");
        $.ajax({
            url : "http://localhost/tadditha/SUTRA.txt",
            dataType: "text",
