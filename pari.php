		...
		if(data1.d[j].Word == document.getElementById("ex").value)
		{
			...
			if(data1.d[j].Sutra != ""){document.getElementById('cont').innerHTML += '<span style="color: #960D4A"><br><b>Reference / संपर्कः :</b></span> <br>';}
				for(aref=0;aref<=data1.d[j].Sutra.length-1;aref++)
				{
					...
					let commBtn = "";
					let comms = "";
					let finalRef = '<table class="diff"><tr><td> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>';
...
<br><br>
<center><h2  style="color: red;">पाणिनीयव्याकरणोदाहरणकोशः - पारिभाषिकपदानि </h2></center>	
</div>
<script>
$(document).on('change', '[name="lang"]' , function(){
	...
	if(val1==="d")
	{
		...
		document.getElementById("a8").innerHTML='पारिभाषिकपदानि';
		document.getElementById("a9").innerHTML='निक्षिपतु';
		
		document.getElementById("i1").innerHTML="अक्षरमालानुसारेण पारिभाषिकपदानि सर्वाणि प्रथमपेटिकायां प्रदर्शितानि। अपेक्षितं पारिभाषिकपदं चिनोतु। ततः तत्पारिभाषिकप्रतिपादकानि सूत्राणि, वार्तिकानि च अष्टाध्यायीसूत्रसंख्यया, सिद्धान्तकौमुदीक्रमसंख्यया, वार्तिकसंख्यया च द्वितीयपेटिकायाम् आविर्भवन्ति। ततः अपेक्षितं सूत्रम्, वार्तिकं वा चिनोतु। ततः उदाहरणानि तृतीयपेटिकायाम् आविर्भवन्ति। ततः अपेक्षितम् उदाहरणं द्रष्टुम् अस्तु इत्यत्र नोदनं करोतु।";
		document.getElementById("ct").innerHTML="पारिभाषिकपदानि";
	...
	else if(val1 === "f")
	{
		...
		document.getElementById("i1").innerHTML="Choisir un terme technique dans la fenêtre de gauche, et cliquer pour voir le(s) sūtra concerné(s). Choisir un sūtra dans la deuxième fenêtre. La liste des exemples du sūtra choisi apparaît dans la troisième fenêtre. Sélectionner et cliquer sur OK.";
		document.getElementById("ct").innerHTML="Termes techniques";
	...
	else if(val1 === "e")
	{
		...
		document.getElementById("i1").innerHTML="Select a technical term in the left window, and click on one of them to see the sūtra(-s) concerned.  Select a sūtra in the second window. The list of examples for that sūtra will appear in the last window. Select the example and click on OK.";
		document.getElementById("ct").innerHTML="Technical Terms";
		document.getElementById("cs").innerHTML="&nbsp; &nbsp; &nbsp; Sūtras-s";
...
<p><center>
<label id="i1">
अक्षरमालानुसारेण पारिभाषिकपदानि सर्वाणि प्रथमपेटिकायां प्रदर्शितानि। अपेक्षितं पारिभाषिकपदं चिनोतु। ततः तत्पारिभाषिकप्रतिपादकानि सूत्राणि, वार्तिकानि च अष्टाध्यायीसूत्रसंख्यया, सिद्धान्तकौमुदीक्रमसंख्यया, वार्तिकसंख्यया च द्वितीयपेटिकायाम् आविर्भवन्ति। ततः अपेक्षितं सूत्रम्, वार्तिकं वा चिनोतु। ततः उदाहरणानि तृतीयपेटिकायाम् आविर्भवन्ति। ततः अपेक्षितम् उदाहरणं द्रष्टुम् अस्तु इत्यत्र नोदनं करोतु।
</label>
</center></p>
<br>
<br>
...
<div class="row9">
	<div class="col-3" style="text-align: right;">
		<label id="ct">पारिभाषिकपदानि</label>
	</div>
	<div class="col-9" style="text-align: left;">
		<input list="pari1" name="pari" id="pari" style="width: 50%;" onfocus="this.value=''" onchange="loadSutras();" autocomplete="off" placeholder = "Select Technical Term">
...
<!--
	...
	<br>
	<div style="display: inline-block;"> &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; 
	<input type=button value="अस्तु" id="exbtn1" name="exbtn1" style="width: 50pt;" onClick="exf1();"> </div>
-->
</form>
...
function loadSutras(){
	...
	for (const f of a) 
	{
		...
		//var b = document.getElementById('pari1').value;
		if(b.trim() === ast1[0].trim())
		{
			let ast2 = ast1[1].split(";");
			for(i=0;i<=ast2.length-1;i++)
			{
				const option = document.createElement('option');
				option.value = ast2[i].trim();
...
function loadexamples(){
	...
	var sas = pra1.substring(pra1.indexOf("/")-7); //pra1.split('\t');
...
//  	var val1 = $('[name="l"]:checked').val();
	$("#cont").empty();
        $.ajax({
            url : "http://localhost/tadditha/PARI.txt",
            dataType: "text",
