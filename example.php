			...
			*/
			...
			if(data1.d[j].Prakriya != ""){
				...
				for(k=0;k<=p-1;k++)
				{
					...
					p1[0] = '<tr><td style="padding: 15px;">'+p1[0]+'</td>';
					p1[1] = '<td style="padding: 15px;">'+p1[1]+'</td>';
////					p1[2] = '<td>'+p1[2]+'<div id="'+id1+'" style="display: none;">'+skoumudi+'</div></td>';
					if(sref !== "vartika")
					{
						p1[2] = '<td style="padding: 15px;">'+p1[2]+'<div class="modal fade" id="m'+sref[1]+'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title">सिद्धान्तकौमुदी</h4></div><div class="modal-body" style="height:300px;overflow:scroll">'+skoumudi + '</div><div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div>';
					}
					else
					{
						p1[2] = '<td style="padding: 15px;">'+p1[2]+'</td>';
					}
...
////					alert("p1[2] "+p1[2]);
					p1[3] = '<td style="padding: 15px;">'+p1[3]+'</td></tr>';
...
<br><br>
<center><h2  style="color: red;">पाणिनीयव्याकरणोदाहरणकोशः - उदाहरणानि </h2></center>	
</div>
<script>
$(document).on('change', '[name="lang"]' , function(){
	...
	if(val1==="d")
	{
		...
		document.getElementById("i1").innerHTML="अपेक्षितस्य उदाहरणस्य प्रथमाक्षरं चिनोतु।  अक्षरमालायां यदक्षरं चितं तदक्षरादीनि उदाहरणानि उदाहरणपेटिकायाम् आविर्भवन्ति।  तेषाम् ऊर्ध्वाधोनयनेन मूषकद्वारा ईप्सितम् उदाहरणं  चिनोतु। ततःअस्तु इत्यत्र नोदनं करोतु।";
	...
	else if(val1 === "f")
	{
		...
		document.getElementById("i1").innerHTML="Choisir l’initiale de l’exemple.  Choisir un exemple en déroulant la liste des exemples dans la fenêtre « Exemples » ou saisir l'exemple en utilisant le clavier.  L’exemple saisi apparaît sur la ligne supérieure de la liste. Cliquer dessus, puis sur OK.";
	...
	else if(val1 === "e")
	{
		...
		document.getElementById("i1").innerHTML="Select the first letter of the example.  Select the example by scrolling the list in the window 'Examples' or directly key in the example using the keyboard. The example typed appears on the upper line of the list. Click on it, then on OK.";
		//document.getElementById("cs").innerHTML="Sutras";
...
<br>
<p><center>
<label id="i1">अपेक्षितस्य उदाहरणस्य प्रथमाक्षरं चिनोतु।  अक्षरमालायां यदक्षरं चितं तदक्षरादीनि उदाहरणानि उदाहरणपेटिकायाम् आविर्भवन्ति।  तेषाम् ऊर्ध्वाधोनयनेन मूषकद्वारा ईप्सितम् उदाहरणं  चिनोतु। ततःअस्तु इत्यत्र नोदनं करोतु।</label></center></p>
<br>
<br>
<form name="f1" width="100%" autocomplete="off">
	...
	<input list="examples" name="ex" id="ex" onfocus="this.value=''" onchange="this.blur();" autocomplete="off" placeholder = "Select example">
...
$(document).ready(function() {
    ...
    //alert("in1");
        $.ajax({
            url : "http://localhost/tadditha/words.txt",
            dataType: "text",
