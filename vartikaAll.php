...
<br><br>
<center><h2  style="color: red;">पाणिनीयव्याकरणोदाहरणकोशः - वार्तिकानि - संख्याद्वारा </h2></center>	
</div>
<script>
$(document).on('change', '[name="lang"]' , function(){
	...
	if(val1==="d")
	{
		...
		document.getElementById("i1").innerHTML="तद्धितनिष्पादनार्थम् उपयुक्तानि वार्तिकानि  वार्तिकसंख्यया सह संख्याक्रमेण प्रदर्शितानि। ततः अपेक्षितं वार्तिकं  चिनोतु। ततः तद्वार्तिकसंबद्धानि उदाहरणानि द्वितीयपेटिकायाम् आविर्भवन्ति। ततः अपेक्षितम् उदाहरणं द्रष्टुम् अस्तु इत्यत्र नोदनं करोतु।";
	...
	else if(val1 === "f")
	{
		...
		document.getElementById("i1").innerHTML="Les vārtika sont donnés ici avec leur référence dans l'ordre dans lequel ils apparaissent dans la Siddhāntakaumudī. Choisir un vārtika dans la première fenêtre. La liste des exemples du vārtika choisi apparaît dans la seconde fenêtre. Sélectionner et cliquer sur OK.";
		//document.getElementById("i2").innerHTML="";
	...
	else if(val1 === "e")
	{
		...
		document.getElementById("i1").innerHTML="Vārtikas are given here along with their reference in the order in which they appear in the Siddhāntakaumudī.   Select a vārtika from the list. The examples for this vārtika will appear in the second window.  Select the example and click on OK.";
		//document.getElementById("i2").innerHTML="";
		document.getElementById("cs").innerHTML="&nbsp; &nbsp; &nbsp; Sūtras-s";
...
<center>
<p><center>
<label id="i1">तद्धितनिष्पादनार्थम् उपयुक्तानि वार्तिकानि  वार्तिकसंख्यया सह संख्याक्रमेण प्रदर्शितानि। ततः अपेक्षितं वार्तिकं  चिनोतु। ततः तद्वार्तिकसंबद्धानि उदाहरणानि द्वितीयपेटिकायाम् आविर्भवन्ति। ततः अपेक्षितम् उदाहरणं द्रष्टुम् अस्तु इत्यत्र नोदनं करोतु।
</label>
</center></p>
<!--
<p><center>
<label id="i2">(The list is in the format of Vartika - Vartika number - Astadhayi Sutra Number/Siddhantakaumudi Number)
</label>
</center></p>
-->
<br>
