...
<br><br>
<center><h2  style="color: red;">पाणिनीयव्याकरणोदाहरणकोशः - सूत्राणि-2 - अष्टाध्यायी </h2></center>	
</div>
<script>
$(document).on('change', '[name="lang"]' , function(){
	...
	if(val1==="d")
	{
		...
		document.getElementById("i1").innerHTML="तद्धितनिष्पादनार्थं प्रक्रियासु उपयुक्तानि सूत्राणि   अष्टाध्यायीसूत्रसंख्यया, सिद्धान्तकौमुदीक्रमसंख्यया च प्रथमपेटिकायाम् प्रदर्शितानि।  ततः अपेक्षितं सूत्रं  चिनोतु। ततः तत्सूत्रसंबद्धानि उदाहरणानि द्वितीयपेटिकायाम् आविर्भवन्ति। ततः अपेक्षितम् उदाहरणं द्रष्टुम् अस्तु इत्यत्र नोदनं करोतु। ";
	...
	else if(val1 === "f")
	{
		...
		document.getElementById("i1").innerHTML="Les sūtra sont donnés ici avec leur référence dans l'ordre dans lequel ils apparaissent dans l'Aṣṭādhyāyī. Choisir un sūtra dans la première fenêtre. La liste des exemples dans la dérivation desquels le sūtra choisi intervient apparaît dans la seconde fenêtre. Sélectionner et cliquer sur OK.";
	...
	else if(val1 === "e")
	{
		...
		document.getElementById("i1").innerHTML="Sūtras are given here along with their reference in the order in which they appear in the Aṣṭādhyāyī.  Select a sūtra from the list. The examples in whose derivation the sūtra intervenes will appear in the second window.  Select the example and click on OK.";
		document.getElementById("cs").innerHTML="&nbsp; &nbsp; &nbsp; Sūtra";
...
<p><center>
<label id="i1">
तद्धितनिष्पादनार्थं प्रक्रियासु उपयुक्तानि सूत्राणि   अष्टाध्यायीसूत्रसंख्यया, सिद्धान्तकौमुदीक्रमसंख्यया च प्रथमपेटिकायाम् प्रदर्शितानि।  ततः अपेक्षितं सूत्रं  चिनोतु। ततः तत्सूत्रसंबद्धानि उदाहरणानि द्वितीयपेटिकायाम् आविर्भवन्ति। ततः अपेक्षितम् उदाहरणं द्रष्टुम् अस्तु इत्यत्र नोदनं करोतु।
</center></p>
<br>
<br>
<form name="f1" width="100%" autocomplete="off">
	<label id="cs">सूत्राणि &nbsp; &nbsp; &nbsp; &nbsp;</label>
	<input list="sak1" name="sak1" id="sak" style="width: 50%;" onfocus="this.value=''" onchange="loadexamples();" style="width: 30%;" autocomplete="off" placeholder = "Select Sutra">
...
function loadexamples(){
	...
	readTextFile("http://localhost/tadditha/tadditha.JSON", function(text){
		...
		{
			try{
			for(j=0;j <= data1.d[i].Prakriya.length-1;j++)
			{
				if(data1.d[i].Prakriya[j].indexOf(sas[1]) !== -1)
				{
...
//  	var val1 = $('[name="l"]:checked').val();
	$("#cont").empty();
        $.ajax({
            url : "http://localhost/tadditha/sutra2.txt",
            dataType: "text",
